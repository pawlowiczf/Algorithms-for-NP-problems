...
def loadX3CWithSolution( name ):
  """Load an X3C instance in the format:
     ...
     Return a pair (elements, list of sets, solution) where each set is a list and the set at index 0 is a dummy empty set"""

  n = 0
  sets = []

  flag = False 
  nameParsed = name.split(".")
  if nameParsed[2] == 'yes': flag = True 
